...
namespace instance.id.AAI.Editors
{
    ...
    public class AAIDefaultEditor : Editor
    {
        ...
        private void OnEnable() // @formatter:on
        {
            ...
            if (defaultStyleSheet is null) defaultStyleSheet = idConfig.GetStyleSheet("AAIDefaultEditorStyle");
            ...
            if (classData.categoryList.Count < 1) return classDict;
            {
                ...
                classData.categoryList.ForEach(x =>
                {
                    ...
                    if (isAnimated)
                    {
                        ...
                        if (!categoryList.Exists(c => c.name == element.name)) categoryList.TryAddValue(element);
                    }
                    else
                    {
        ...
        public override VisualElement CreateInspectorGUI()
        {
            ...
            if (beforeDefaultElements == null) beforeDefaultElements = new VisualElement();
            ...
            if (afterDefaultElements == null) afterDefaultElements = new VisualElement();
