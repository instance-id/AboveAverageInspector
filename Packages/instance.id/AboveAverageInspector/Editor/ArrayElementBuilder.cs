        ...
        private VisualElement AddItem(SerializedProperty property, string propertyPath, int index, bool hideSelector = true)
        {
            ...
            else
            {
                switch (fieldType.fieldTypeParameters[0])
                {
                    ...
                    case Type b when b == typeof(PropertyName):
                    ...
                    case Type a when a == typeof(bool):
                        ...
                        break;
                    case Type a when a == typeof(Object):
                    case Type b when typeof(Object).IsSubclassOf(b):
                    case Type c when typeof(Object).IsAssignableFrom(c):
